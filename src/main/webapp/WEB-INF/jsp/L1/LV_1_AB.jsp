...
<link href="${pageContext.request.contextPath}/js/ctxmenu/dist/fixed/jquery.contextMenu.min.css" rel="stylesheet">
<link href="${pageContext.request.contextPath}/js/ctxmenu/dist/jquery.contextMenuCommon.min.css" rel="stylesheet">

<script src="${pageContext.request.contextPath}/js/ctxmenu/dist/jquery-ui-position.min.js"></script>
<script src="${pageContext.request.contextPath}/js/ctxmenu/dist/fixed/jquery.contextMenu.min.js"></script>
<script src="${pageContext.request.contextPath}/js/ctxmenu/dist/jquery.contextMenuCommon.min.js"></script>
